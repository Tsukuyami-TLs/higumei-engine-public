...
style button_story_locked:
    activate_sound "audio/sfx/SE_004_Tap.wav"
    background Frame("gui/button/FrmBlood_lock.png", left=280, top=20, right=240, bottom=None, tile=False)
    xminimum 1300
    yminimum 140
...
style button_story_locked_text:
    color "#000"
    align (0.5, 0.5)
...
style button_sort:
    activate_sound "audio/sfx/SE_004_Tap.wav"
    idle_background "gui/button/BtnGeneric.png"
    hover_background "gui/button/BtnGenericOn.png"
    xpos 40
    yalign 0.95
    xminimum 575
    yminimum 65

style button_sort_text:
    size 45
    color "#000"
    xoffset 40
    yoffset 8
...
style game_menu_exit_box is game_menu_outer_frame
style game_menu_exit_box:
    xpos gui.navigation_xpos
    yalign 1.0
    top_padding 0
