label event01_30_00:
 ...
 show nao_v002 normal at active
 show mion_v002 smile at inactive
 nao "Rokkenjima... It's a small, privately owned island, right?"
 ...
 nao '...I guess the grass is always greener on the other side.'
 hide nao_v002
 with Dissolve(0.2)
 ...
 erika "On purpose? Please don't say such bad things about people."
 camera at screenshake_transform
 pause 0.0
 show nao_v002 sinken at active
 ...
 show erika_v001 normal at active
 show nao_v002 fuan at inactive
 erika "Similarly, me sticking out my leg and causing the child to fall isn't an issue as we both have witnessed this."
 show nao_v002 sinken at active
 show erika_v001 normal at inactive
 ...
 show nao_v002 sinken at active
 show erika_v001 normal_close at inactive
 nao 'How good can your intent be when you watched the child run up to you? Can you make that clear to me?'
 camera at screenshake_transform
 pause 0.0
 show nao_v002 sinken at active
 show erika_v001 normal_close at inactive
 ...
 show erika_v001 normal at active
 show nao_v002 sinken at inactive
 erika "A child was running, tripped on my leg, and fell. And then, there's whether or not it was {i}on purpose{/i}..."
 show erika_v001 normal at active
 show nao_v002 sinken at inactive
 erika 'You claim that I tripped that child on purpose, while I claim that the child tripping on my leg was a coincidence. '
 show erika_v001 normal at active
 show nao_v002 sinken at inactive
 ...
 show nao_v002 normal at active
 show erika_v001 normal at inactive
 nao 'To arrive at the truth within the catbox... in your words, you would need solid evidence.'
 show erika_v001 normal at active
 show nao_v002 normal at inactive
 ...
 show nao_v002 normal at inactive
 erika 'When you say I stuck out my leg on {i}purpose{/i}, do you happen to have proof for that?'
 camera at screenshake_transform
 pause 0.0
 show nao_v002 sinken at active
 ...
 show erika_v001 normal at active
 show nao_v002 sinken at inactive
 erika 'In other words, there is a possibility that there could be something wrong with your sight, so it impedes your ability to properly witness events. I also declare that there is a possibility something is wrong with your brain, so you make up everything that you say.'
 ...
 show erika_v001 normal at active
 show nao_v002 fuan at inactive
 erika 'The result. According to the work of competent lawyers, although there may have been eyewitnesses to a crime, their ability to prove that fact may be rejected as well.'
 show nao_v002 fuan at active
 show erika_v001 normal at inactive
 ...
 erika 'Even if there is clear evidence or an eyewitness, just with the negotiations between the lawyer and attorney alone, it is possible for them to rule evidence as rejectable or as a misobservation!'
 camera at screenshake_transform
 pause 0.0
 show erika_v001 fuan at active
 erika "When this ridiculous court farce contaminates such beautiful reasoning, doesn't just thinking about it make you sick?!"
 show erika_v001 futeki at active
 erika "That's why I want to respect it! The fact that you say you clearly witnessed it in your testimony!"
 show erika_v001 futeki at active
 erika "No, no, it's not just that! It's the fact that I, in the period of me being lost in my own intelligent thoughts, was disturbed by this loud, annoying, bumbling snot-nosed BRAT running amok, so you believe that I kicked out my leg in the crime scene!!!"
 show erika_v001 normal_close at active
 erika 'Aah, if this was a proper mystery world, your witness report would be respected above all else, and it ought to beautifully put an end to me in a checkmate!'
 show erika_v001 futeki at active
 ...
 erika "Goodbye. I won't even remember you, you irrelevant random."
 show nao_v002 sinken at active
 show erika_v001 normal at inactive
 nao "That's my line..."
 hide erika_v001
 ...
 show erika_v001 normal at inactive
 dlanor 'As usual... you do not behave MATURELY.'
 show erika_v001 normal at active
 ...
 show erika_v001 normal at inactive
 dlanor 'If the noisy children were bothering you in the first place, you should have taken the time to move to another LOCATION.'
 show erika_v001 normal_close at active
 ...
 show dlanor_v001 fuan_close at active
 show erika_v001 normal at inactive
 dlanor "For me to even call a character like that a friend of mine doesn't sit well in my HEART."
 show erika_v001 normal_close at active
 show dlanor_v001 fuan_close at inactive
 erika 'Hmph. Says the killer doll without a heart.'
 ...
 show dlanor_v001 normal at active
 show erika_v001 normal_close at inactive
 dlanor "I understand it loud and CLEAR. ...I was thinking that I might have disappointed with this method of delivering a celebration present for Beatrice's BIRTHDAY."
 show erika_v001 sinken at active
 show dlanor_v001 normal at inactive
 ...
 show erika_v001 normal at active
 show dlanor_v001 normal at inactive
 erika 'Well, I guess you are right. I am the detective after all. Wherever I go, an incident will occur.'
 show erika_v001 normal at active
 show dlanor_v001 normal at inactive
 ...
 show dlanor_v001 normal_close at active
 show erika_v001 normal at inactive
 dlanor '...It is both a surprise and honor that you enjoy speaking to me so MUCH.'
 show erika_v001 fuan at active
