label event01_30_02:
 ...
 Character('Mion Sonozaki',ctc="ctcArrow", ctc_position="fixed") 'From the beginning, the "Sono" (園) kanji in "Sonozaki" (園崎)... has depicted human organs, while the "Zaki" (崎) kanji... '
